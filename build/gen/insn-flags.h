...
#define HAVE_madsi (TARGET_MAD || GENERATE_MADD)
...
#define HAVE_madd3 (GENERATE_MADD)
...
#define HAVE_high (mips_split_addresses)
#define HAVE_low (mips_split_addresses)
#define HAVE_movdi 1
...
#define HAVE_builtin_setjmp_receiver (TARGET_ABICALLS && mips_abi != ABI_32)
...
extern rtx gen_madd3                         PROTO((rtx, rtx, rtx, rtx));
...
extern rtx gen_builtin_setjmp_receiver       PROTO((void));
...
extern rtx gen_builtin_setjmp_receiver ();
